...
//
//==============================================================================
#ifndef ENEMY_KATANA_H
#define ENEMY_KATANA_H

#include <DirectXMath.h>
#include "game_enemy.h"
#include "game_player.h"

class EnemyKatana : public Enemy
{
private:
...
public:
	EnemyKatana(DirectX::XMFLOAT2 position, DirectX::XMFLOAT2 size);
	~EnemyKatana() = default;
